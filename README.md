...
### Decomposition
The algorithm requires some components:
- A range-specific iterator
- An array reorganizer

### Pattern Recognition
Each time a new pivot is chosen, the same operation is performed. There can be some callable method that will make code simpler
