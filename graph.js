...
// Class translated with AI from Python
class Color {
    constructor(r, g, b) {
        this.r = r;
        this.g = g;
...
//  Constants translated with AI from PYTHON
...
// Busy waits for an element based on an id
...
// Copies an element to the graphOverlay DOM
// Function Generated by ChatGPT
function copyElementToOverlay(original) { // Used ChatGPT Level 4 to generate this function because this is my first time using JS
...
// Animates the swap of two indices in the array
...
// Handles updating the chart based on new data
...
waitForElementById("graph-data", (ele) => {
    ...
    new MutationObserver((mutations, self) => { // not sure if js requires parameter and argument counts to match
        onNewData();
